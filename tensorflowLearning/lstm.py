...
def lstm_cell():
    cell = rnn.BasicLSTMCell(num_units=hidden_size, forget_bias=1.0, state_is_tuple=True, reuse=tf.get_variable_scope().reuse)
...
for i in range(2000):
    ...
    if (i+1) % 200 == 0:
        ...
        print("Iter {}, step {}, training accuracy {}".format(mnist.train.epochs_completed, (i+1), train_accuracy))
